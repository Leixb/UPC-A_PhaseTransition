...
DY=0.10 compute GRG numCompCon	 	| YLABEL="Avg. Mida component connexa gegant" 	XLABEL=r pipe "Components conexes en Geometric Random Graph"
DY=0.01 compute GRG esConnex	 	| YLABEL="Probabilitat de ser connex" 			XLABEL=r pipe "Connectivitat en Geometric Random Graph"
DY=0.10 compute GRG midaCompConMax 	| YLABEL="Avg. Mida component connexa gegant" 	XLABEL=r pipe "Mida component conexa gegant en Geometric Random Graph"
DY=0.01 compute GRG cicle 			| YLABEL="Probabilitat de tenir cicle"		    XLABEL=r pipe "Cicles en Geometric Random Graph"
DY=0.01 compute GRG eulerianPath 	| YLABEL="Probabilitat de tenir camí eulerià"	XLABEL=r pipe "Camí eulerià en Geometric Random Graph"
DY=0.01 compute GRG eulerianCycle 	| YLABEL="Probabilitat de tenir cicle eulerià"	XLABEL=r pipe "Cicle eulerià en Geometric Random Graph"

DY=0.10 compute BRG numCompCon	 	| YLABEL="Avg. Mida component connexa gegant" 	XLABEL=p pipe "Components conexes en Binomial Random Graph"
DY=0.01 compute BRG esConnex	 	| YLABEL="Probabilitat de ser connex" 			XLABEL=p pipe "Connectivitat en Binomial Random Graph"
DY=0.10 compute BRG midaCompConMax 	| YLABEL="Avg. Mida component connexa gegant" 	XLABEL=p pipe "Mida Component conexa gegant en Binomial Random Graph"
DY=0.01 compute BRG cicle 			| YLABEL="Probabilitat de tenir cicle"		 	XLABEL=p pipe "Cicles en Binomial Random Graph"
DY=0.01 compute BRG eulerianPath 	| YLABEL="Probabilitat de tenir camí eulerià" 	XLABEL=p pipe "Camí eulerià en Binomial Random Graph"
DY=0.01 compute BRG eulerianCycle 	| YLABEL="Probabilitat de tenir cicle eulerià" 	XLABEL=p pipe "Cicle eulerià en Binomial Random Graph"
